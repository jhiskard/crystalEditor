...
private:
    ...
    // ========================================================================
    std::unique_ptr<structure::application::StructureServicePort> m_structureServicePort;
    std::unique_ptr<measurement::application::MeasurementServicePort> m_measurementServicePort;
    std::unique_ptr<density::application::DensityServicePort> m_densityServicePort;
