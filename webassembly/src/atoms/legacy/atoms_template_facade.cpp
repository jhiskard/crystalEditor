...
#include "../application/density_service_legacy_port_adapter.h"
#include "../application/structure_service_legacy_port_adapter.h"
#include "../application/measurement_service_legacy_port_adapter.h"
...
AtomsTemplate::AtomsTemplate() {
    ...
    m_structureServicePort =
        std::make_unique<atoms::application::StructureServiceLegacyPortAdapter>(this);
    m_measurementServicePort =
        std::make_unique<atoms::application::MeasurementServiceLegacyPortAdapter>(this);
    m_densityServicePort =
        std::make_unique<atoms::application::DensityServiceLegacyPortAdapter>(this);
    m_structureService = std::make_unique<structure::application::StructureService>(m_structureServicePort.get());
    m_measurementService = std::make_unique<measurement::application::MeasurementService>(m_measurementServicePort.get());
    m_densityService = std::make_unique<density::application::DensityService>(m_densityServicePort.get());
...
void AtomsTemplate::RequestBuilderSection(workbench::panel::BuilderRequest section) {
    switch (section) {
...
void AtomsTemplate::RequestEditorSection(workbench::panel::EditorRequest section) {
    switch (section) {
...
void AtomsTemplate::RequestDataMenu(workbench::panel::DataRequest request) {
    switch (request) {
