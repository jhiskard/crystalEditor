 ...
 * @details atoms::domain::initializeAtomGroup()???몄텧???? WorkspaceRuntimeModel??VTK 洹몃９ 珥덇린?붾? ?꾩엫?⑸땲??
 * @note Affects: atoms::domain::atomGroups, m_vtkRenderer??atom group ?뚯씠?꾨씪??
 * @note Called by: webassembly/src/atoms/atoms_template.cpp (WorkspaceRuntimeModel::createAtomSphere).
 */
 ...
 * @details WorkspaceRuntimeModel::updateUnifiedAtomGroupVTK()濡??꾩엫?섎뒗 ?꾩뿭 ?섑띁?낅땲??
...
public:
    ...
    ~WorkspaceRuntimeModel();
    WorkspaceRuntimeModel(const WorkspaceRuntimeModel&) = delete;
    WorkspaceRuntimeModel& operator=(const WorkspaceRuntimeModel&) = delete;
    WorkspaceRuntimeModel(WorkspaceRuntimeModel&&) = delete;
    WorkspaceRuntimeModel& operator=(WorkspaceRuntimeModel&&) = delete;
     ...
     * @note Called by: WorkspaceRuntimeModel::LoadXSFFile, WorkspaceRuntimeModel::setBravaisLattice.
     */
     ...
     * @note Called by: WorkspaceRuntimeModel::LoadXSFFile, WorkspaceRuntimeModel::applyAtomChanges,
     *                  WorkspaceRuntimeModel::applyCellChanges,
     ...
     * @note Called by: WorkspaceRuntimeModel::updatePerformanceStatsInternal.
     */
     ...
     * @note Called by: WorkspaceRuntimeModel::setBravaisLattice,
...
private:
     ...
     * @note Called by: WorkspaceRuntimeModel::createAtomSphere.
     */
