...
## Phase 6. 테스트/회귀 체계 도입 (병행, 2026-03-31 완료)
- 작업
  - 최소 단위 테스트 대상
    - CHGCAR/XSF 파서
    - 좌표 변환(cell matrix)
...
- [Phase 2(상태 저장소 통합) 세부 계획서](./refactoring_phase2_state_store_integration_260330.md)
- [Phase 3(Import 파이프라인 분리) 세부 계획서](./docs/refactoring/phase3/refactoring_phase3_import_pipeline_separation_260330.md)
- [Phase 4(UI 렌더러 분해) 세부 계획서](./docs/refactoring/phase4/refactoring_phase4_ui_renderer_split_260330.md)
- [Phase 5(빌드 시스템 모듈화) 세부 계획서](./docs/refactoring/phase5/refactoring_phase5_build_system_modularization_260331.md)
- [Phase 6(테스트/회귀 체계 도입) 세부 계획서](./docs/refactoring/phase6/refactoring_phase6_test_regression_system_260331.md)
